...
class RoundedCoordinatorLayout @JvmOverloads constructor(
    context: Context,
    ...
    init {
        val a: TypedArray = context.obtainStyledAttributes(
            attrs, R.styleable.RoundedCoordinatorLayout)
        val roundedCorners = a.getInt(R.styleable.RoundedCoordinatorLayout_roundedCorners,
